...
namespace Intermidia.Intermidia.Infra.Domain.Repositories
{
    public interface ICarrinhoRepository
    {
        ...
        Task<WcfPedidoModelInput> BuscarCarrinhoParaTransmissao(string codCarrinho, string codSufarmaCliente = "", Boolean materialPDV = false);
        ...
        Task<List<string>> ValidacoesDoCarrinho(string codCarrinho, Boolean validaTipoFrete);
